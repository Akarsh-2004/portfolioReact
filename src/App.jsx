    ...
    return (
      ...
      <div
        style={{
          ...
          position: "relative",
          background:
            "linear-gradient(180deg, transparent 0%, rgba(199, 125, 255, 0.05) 50%, transparent 100%)",
        }}
      >
        <div
          style={{
            ...
            height: "1px",
            background:
              "linear-gradient(90deg, transparent 0%, rgba(199, 125, 255, 0.3) 50%, transparent 100%)",
            top: "50%",
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(199, 125, 255, 0.1) 0%, transparent 70%)",
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
            position: "relative",
      ...
      <div
        style={{
          ...
          padding: "6rem 2rem",
          background:
            "linear-gradient(180deg, transparent 0%, rgba(199, 125, 255, 0.03) 50%, transparent 100%)",
          position: "relative",
        }}
      >
        <div
          style={{
            ...
            height: "1px",
            background:
              "linear-gradient(90deg, transparent 0%, rgba(199, 125, 255, 0.3) 20%, rgba(255, 107, 157, 0.3) 80%, transparent 100%)",
            top: "50%",
            transform: "translateY(-50%)",
            zIndex: 0,
          }}
      ...
      >
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(199, 125, 255, 0.15) 0%, transparent 70%)",
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
